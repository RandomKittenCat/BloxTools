    ...
    public boolean onCommand(@Nonnull CommandSender sender, @Nonnull Command command, String label, @Nonnull String[] args){
        if (label.equalsIgnoreCase("btinfo")){
            if (sender instanceof Player p){
                ...
                p.sendMessage(ChatColor.RED + "The BloxTools plugin is made and maintained by MrBloxMan, you can view the source code here: https://github.com/RandomKittenCat/BloxTools");
            }
        }
        return true;
    }
